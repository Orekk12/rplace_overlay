...
if (window.top !== window.self) {
    window.addEventListener('load', () => {
        ...
        (function () {
            ...
            div.id = "Silksong";
            div.style = "height:2300px; width:2500px; position: absolute; inset: 0px; transform: translateX(24050px) translateY(21250px);     background-size: cover;" +
