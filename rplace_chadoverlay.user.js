...
if (window.top !== window.self) {
    window.addEventListener('load', () => {
        ...
        (function () {
            ...
            div.id = "CHAD";
            div.style = "height:3600px; width:6400px; position: absolute; inset: 0px; transform: translateX(60050px) translateY(35050px);   background-size: cover; image-rendering: pixelated;" +
    "background-image: url('https://github.com/Orekk12/rplace_overlay/raw/main/greekgod_pperfect2.jpg'); opacity: 0.3;";
            return div;
        })())
        ...
        (function () {
            ...
            input.addEventListener('input', (event) => {
                document.getElementsByTagName("mona-lisa-embed")[0].shadowRoot.children[0].getElementsByTagName("mona-lisa-camera")[0].shadowRoot.children[0].children[0].children[0].querySelector("#CHAD").style.opacity = event.currentTarget.value;
            });
